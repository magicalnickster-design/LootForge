...
const DOC_IDS = Object.freeze({
  ...
  "giant-tooth": "LFGiantTooth0000",
  "giant-knuckle": "LFGiantKnuckle00",
  "giant-hair-lock": "LFGiantHair00000",
  "hill-giant-rock": "LFHillGiantRock0",
  "stone-giant-chip": "LFStoneGiantChp0",
  "frost-giant-ice": "LFFrostGiantIce0",
  "fire-giant-slag": "LFFireGiantSlag0",
  "cloud-giant-silk": "LFCloudGiantSlk0",
  "storm-spark-stone": "LFStormSparkStn0",
  "giant-thumb-ring": "LFGiantThumbRng0",
  "boulder-charm": "LFBoulderCharm00",
  "rune-carved-pebble": "LFRunePebble0000",
  "giant-boot-scrap": "LFGiantBootScrp0",
  "crushed-wagon-spoke": "LFCrushedSpoke00",
  "greasy-sack-scrap": "LFGreasySack0000",
  "cracked-boulder": "LFCrackedBouldr0",
  "tribute-list": "LFTributeList000",
  "giant-clan-mark": "LFGiantClanMark0",
  "storm-omen-note": "LFStormOmenNote0",
  "raiding-map": "LFRaidingMap0000",
});
...
export const LOOT_DEFINITIONS = {
  ...
  "giant-tooth": {
    id: "giant-tooth",
    documentId: DOC_IDS["giant-tooth"],
    itemUuid: compendiumItemUuid(DOC_IDS["giant-tooth"]),
    name: "Giant Tooth",
    category: "monster-part",
    rarity: "uncommon",
    tags: ["giant","trophy","bone"],
    img: `modules/${MODULE_ID}/assets/items/giant-tooth.svg`,
    description: "A tooth the size of a dagger hilt. Still has dinner stuck in the groove.",
    price: {"value":2,"denomination":"gp"},
    weight: {"value":1,"units":"lb"}
  },
  "giant-knuckle": {
    id: "giant-knuckle",
    documentId: DOC_IDS["giant-knuckle"],
    itemUuid: compendiumItemUuid(DOC_IDS["giant-knuckle"]),
    name: "Giant Knuckle Bone",
    category: "monster-part",
    rarity: "uncommon",
    tags: ["giant","trophy","bone"],
    img: `modules/${MODULE_ID}/assets/items/giant-knuckle.svg`,
    description: "A knuckle bone big enough to use as a club. Dice-makers and ogres both want it.",
    price: {"value":3,"denomination":"gp"},
    weight: {"value":2,"units":"lb"}
  },
  "giant-hair-lock": {
    id: "giant-hair-lock",
    documentId: DOC_IDS["giant-hair-lock"],
    itemUuid: compendiumItemUuid(DOC_IDS["giant-hair-lock"]),
    name: "Giant Hair Lock",
    category: "monster-part",
    rarity: "common",
    tags: ["giant","alchemy"],
    img: `modules/${MODULE_ID}/assets/items/giant-hair-lock.svg`,
    description: "A greasy lock of giant hair, rope-thick. Alchemists braid it into strength draughts.",
    price: {"value":8,"denomination":"sp"},
    weight: {"value":0.3,"units":"lb"}
  },
  "hill-giant-rock": {
    id: "hill-giant-rock",
    documentId: DOC_IDS["hill-giant-rock"],
    itemUuid: compendiumItemUuid(DOC_IDS["hill-giant-rock"]),
    name: "Hill Giant Throwing Rock",
    category: "monster-part",
    rarity: "common",
    tags: ["giant","hill-giant","weapon"],
    img: `modules/${MODULE_ID}/assets/items/hill-giant-rock.svg`,
    description: "A fist-sized (for a giant) rock, scuffed from throwing practice. Still usable as a siege pebble.",
    price: {"value":5,"denomination":"sp"},
    weight: {"value":8,"units":"lb"}
  },
  "stone-giant-chip": {
    id: "stone-giant-chip",
    documentId: DOC_IDS["stone-giant-chip"],
    itemUuid: compendiumItemUuid(DOC_IDS["stone-giant-chip"]),
    name: "Stone Giant Chip",
    category: "monster-part",
    rarity: "uncommon",
    tags: ["giant","stone-giant","stone"],
    img: `modules/${MODULE_ID}/assets/items/stone-giant-chip.svg`,
    description: "A flake of living stone from a stone giant's skin. Carvers say it remembers shapes.",
    price: {"value":4,"denomination":"gp"},
    weight: {"value":1,"units":"lb"}
  },
  "frost-giant-ice": {
    id: "frost-giant-ice",
    documentId: DOC_IDS["frost-giant-ice"],
    itemUuid: compendiumItemUuid(DOC_IDS["frost-giant-ice"]),
    name: "Frost Giant Ice Shard",
    category: "monster-part",
    rarity: "uncommon",
    tags: ["giant","frost-giant","alchemy","cold"],
    img: `modules/${MODULE_ID}/assets/items/frost-giant-ice.svg`,
    description: "A shard of ice that never melts in a cool cellar. Burns bare skin like frostbite.",
    price: {"value":6,"denomination":"gp"},
    weight: {"value":0.5,"units":"lb"}
  },
  "fire-giant-slag": {
    id: "fire-giant-slag",
    documentId: DOC_IDS["fire-giant-slag"],
    itemUuid: compendiumItemUuid(DOC_IDS["fire-giant-slag"]),
    name: "Fire Giant Slag",
    category: "monster-part",
    rarity: "uncommon",
    tags: ["giant","fire-giant","alchemy","fire"],
    img: `modules/${MODULE_ID}/assets/items/fire-giant-slag.svg`,
    description: "A lump of forge-slag still warm days later. Fire giants treat it like pocket change.",
    price: {"value":5,"denomination":"gp"},
    weight: {"value":1.5,"units":"lb"}
  },
  "cloud-giant-silk": {
    id: "cloud-giant-silk",
    documentId: DOC_IDS["cloud-giant-silk"],
    itemUuid: compendiumItemUuid(DOC_IDS["cloud-giant-silk"]),
    name: "Cloud Giant Silk Scrap",
    category: "monster-part",
    rarity: "rare",
    tags: ["giant","cloud-giant","cloth"],
    img: `modules/${MODULE_ID}/assets/items/cloud-giant-silk.svg`,
    description: "A scrap of sky-silk, lighter than it looks. Cloud giant clothing never quite falls.",
    price: {"value":15,"denomination":"gp"},
    weight: {"value":0.1,"units":"lb"}
  },
  "storm-spark-stone": {
    id: "storm-spark-stone",
    documentId: DOC_IDS["storm-spark-stone"],
    itemUuid: compendiumItemUuid(DOC_IDS["storm-spark-stone"]),
    name: "Storm Spark Stone",
    category: "monster-part",
    rarity: "rare",
    tags: ["giant","storm-giant","alchemy","lightning"],
    img: `modules/${MODULE_ID}/assets/items/storm-spark-stone.svg`,
    description: "A dark stone that crackles when rubbed. Storm giants keep them as prayer beads.",
    price: {"value":25,"denomination":"gp"},
    weight: {"value":0.4,"units":"lb"}
  },
  "giant-thumb-ring": {
    id: "giant-thumb-ring",
    documentId: DOC_IDS["giant-thumb-ring"],
    itemUuid: compendiumItemUuid(DOC_IDS["giant-thumb-ring"]),
    name: "Giant Thumb Ring",
    category: "trinket",
    rarity: "uncommon",
    tags: ["giant","trinket"],
    img: `modules/${MODULE_ID}/assets/items/giant-thumb-ring.svg`,
    description: "A metal ring sized for a giant's thumb — a bracelet for a human, a trophy either way.",
    price: {"value":8,"denomination":"gp"},
    weight: {"value":0.5,"units":"lb"}
  },
  "boulder-charm": {
    id: "boulder-charm",
    documentId: DOC_IDS["boulder-charm"],
    itemUuid: compendiumItemUuid(DOC_IDS["boulder-charm"]),
    name: "Boulder Charm",
    category: "trinket",
    rarity: "common",
    tags: ["giant","trinket"],
    img: `modules/${MODULE_ID}/assets/items/boulder-charm.svg`,
    description: "A tiny carved boulder on a leather cord. Hill giants give these to kids who throw well.",
    price: {"value":5,"denomination":"sp"},
    weight: {"value":0.15,"units":"lb"}
  },
  "rune-carved-pebble": {
    id: "rune-carved-pebble",
    documentId: DOC_IDS["rune-carved-pebble"],
    itemUuid: compendiumItemUuid(DOC_IDS["rune-carved-pebble"]),
    name: "Rune-Carved Pebble",
    category: "trinket",
    rarity: "uncommon",
    tags: ["giant","stone-giant","trinket"],
    img: `modules/${MODULE_ID}/assets/items/rune-carved-pebble.svg`,
    description: "A pebble etched with a stone giant rune. The meaning is \"patience\" — or \"crush.\"",
    price: {"value":2,"denomination":"gp"},
    weight: {"value":0.2,"units":"lb"}
  },
  "giant-boot-scrap": {
    id: "giant-boot-scrap",
    documentId: DOC_IDS["giant-boot-scrap"],
    itemUuid: compendiumItemUuid(DOC_IDS["giant-boot-scrap"]),
    name: "Giant Boot Scrap",
    category: "junk",
    rarity: "common",
    tags: ["giant","junk"],
    img: `modules/${MODULE_ID}/assets/items/giant-boot-scrap.svg`,
    description: "A torn scrap of leather from a giant's boot. Smells like road and livestock.",
    price: {"value":2,"denomination":"cp"},
    weight: {"value":0.3,"units":"lb"}
  },
  "crushed-wagon-spoke": {
    id: "crushed-wagon-spoke",
    documentId: DOC_IDS["crushed-wagon-spoke"],
    itemUuid: compendiumItemUuid(DOC_IDS["crushed-wagon-spoke"]),
    name: "Crushed Wagon Spoke",
    category: "junk",
    rarity: "common",
    tags: ["giant","junk"],
    img: `modules/${MODULE_ID}/assets/items/crushed-wagon-spoke.svg`,
    description: "A wagon spoke snapped in a giant's fist. Proof someone met the wrong traveler.",
    price: {"value":1,"denomination":"cp"},
    weight: {"value":0.5,"units":"lb"}
  },
  "greasy-sack-scrap": {
    id: "greasy-sack-scrap",
    documentId: DOC_IDS["greasy-sack-scrap"],
    itemUuid: compendiumItemUuid(DOC_IDS["greasy-sack-scrap"]),
    name: "Greasy Sack Scrap",
    category: "junk",
    rarity: "common",
    tags: ["giant","junk"],
    img: `modules/${MODULE_ID}/assets/items/greasy-sack-scrap.svg`,
    description: "A scrap of a giant's food sack, stiff with grease and old meat.",
    price: {"value":1,"denomination":"cp"},
    weight: {"value":0.15,"units":"lb"}
  },
  "cracked-boulder": {
    id: "cracked-boulder",
    documentId: DOC_IDS["cracked-boulder"],
    itemUuid: compendiumItemUuid(DOC_IDS["cracked-boulder"]),
    name: "Cracked Boulder Chunk",
    category: "junk",
    rarity: "common",
    tags: ["giant","junk"],
    img: `modules/${MODULE_ID}/assets/items/cracked-boulder.svg`,
    description: "A chunk of boulder split by a giant's practice throw. Ordinary rock with a story.",
    price: {"value":1,"denomination":"cp"},
    weight: {"value":3,"units":"lb"}
  },
  "tribute-list": {
    id: "tribute-list",
    documentId: DOC_IDS["tribute-list"],
    itemUuid: compendiumItemUuid(DOC_IDS["tribute-list"]),
    name: "Tribute List",
    category: "story",
    rarity: "uncommon",
    tags: ["giant","story","readable"],
    img: `modules/${MODULE_ID}/assets/items/tribute-list.svg`,
    description: "A crude list of villages and what they owe: \"oxen, ale, gold, silence.\"",
    price: {"value":5,"denomination":"sp"},
    weight: {"value":0.05,"units":"lb"}
  },
  "giant-clan-mark": {
    id: "giant-clan-mark",
    documentId: DOC_IDS["giant-clan-mark"],
    itemUuid: compendiumItemUuid(DOC_IDS["giant-clan-mark"]),
    name: "Giant Clan Mark",
    category: "story",
    rarity: "uncommon",
    tags: ["giant","story","readable"],
    img: `modules/${MODULE_ID}/assets/items/giant-clan-mark.svg`,
    description: "A strip of hide branded with a giant clan rune. Carrying it may buy passage — or a fight.",
    price: {"value":1,"denomination":"gp"},
    weight: {"value":0.1,"units":"lb"}
  },
  "storm-omen-note": {
    id: "storm-omen-note",
    documentId: DOC_IDS["storm-omen-note"],
    itemUuid: compendiumItemUuid(DOC_IDS["storm-omen-note"]),
    name: "Storm Omen Note",
    category: "story",
    rarity: "uncommon",
    tags: ["giant","storm-giant","story","readable"],
    img: `modules/${MODULE_ID}/assets/items/storm-omen-note.svg`,
    description: "A note in careful giant-script: \"Thunder on the third night. The sea will answer.\"",
    price: {"value":8,"denomination":"sp"},
    weight: {"value":0.05,"units":"lb"}
  },
  "raiding-map": {
    id: "raiding-map",
    documentId: DOC_IDS["raiding-map"],
    itemUuid: compendiumItemUuid(DOC_IDS["raiding-map"]),
    name: "Raiding Map",
    category: "story",
    rarity: "uncommon",
    tags: ["giant","story","readable"],
    img: `modules/${MODULE_ID}/assets/items/raiding-map.svg`,
    description: "A map of roads and farms with X marks. Someone planned a hungry walk.",
    price: {"value":6,"denomination":"sp"},
    weight: {"value":0.05,"units":"lb"}
  }
};
