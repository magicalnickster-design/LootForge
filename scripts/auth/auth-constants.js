...
export const PRODUCT_ID = "lootforge";
...
export const SETTING_ENTITLEMENT_CACHE = "lootforgeEntitlementCache";
export const SETTING_WORLD_ACCESS = "lootforgeWorldAccess";
